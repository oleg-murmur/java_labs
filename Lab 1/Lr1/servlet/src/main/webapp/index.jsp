...
<h1 class='text-center' style='font-size:50px; color:DodgerBlue;'>
    Band
</h1>

<p class='text-center' style="color:DodgerBlue;">
    Band - креативное агентство, которое использует дизайн, чтобы помочь организациям, оказывающим социальное воздействие, решать самые насущные мировые проблемы.
</p>
